      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <form onSubmit={handleSearch} className="hidden md:flex items-center">
            ...
            <button
              type="submit"
              className="bg-yellow-400 text-white px-4 py-1 rounded-r-md hover:bg-yellow-500 transition"
            >
              Search
            </button>
          </form>
        ...
        {menuOpen && (
          <div className="md:hidden mt-2 bg-gray-800 rounded shadow-lg">
            ...
            <form onSubmit={handleSearch} className="px-4 py-2">
              ...
              <button
                type="submit"
                className="mt-2 w-full bg-yellow-400 text-white py-1 rounded hover:bg-yellow-500 transition"
              >
                Search
              </button>
            </form>
